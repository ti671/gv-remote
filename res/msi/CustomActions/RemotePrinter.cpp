...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"Gv Remote Printer";
    LPCWCH RD_PRINTER_NAME = L"Gv Remote Printer";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through Gv Remote Printer.
